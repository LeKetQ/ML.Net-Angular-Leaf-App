...
app.MapPost("/predict",
    async (PredictionEnginePool<LeafRecognizerModel.ModelInput, LeafRecognizerModel.ModelOutput> predictionEnginePool, string imagePath) =>
    {
        var input = new LeafRecognizerModel.ModelInput()
        {
